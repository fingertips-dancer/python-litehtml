...
*/
    ...
    py::class_<lh::document_container, py_document_container, std::unique_ptr<lh::document_container, py::nodelete>>(m, "document_container")
        .def(py::init<>())
    ;
    py::class_<lh::list_marker>(m, "list_marker")
        .def_readonly("image", &lh::list_marker::image)
        .def_readonly("baseurl", &lh::list_marker::baseurl)
        .def_readonly("marker_type", &lh::list_marker::marker_type)
        .def_readonly("color", &lh::list_marker::color)
        .def_readonly("pos", &lh::list_marker::pos)
        .def_readonly("index", &lh::list_marker::index)
        .def_readonly("font", &lh::list_marker::font)
    ;
